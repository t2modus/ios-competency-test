...
class IndividualDetailController: ScrollViewController, UITextFieldDelegate {
    ...
    override func viewDidLoad() {
        ...
        fullNameTextField?.text = "\(tempIndividual.first_name) \(tempIndividual.last_name)"
        ...
        if (tempIndividual.img.isEmpty == false) {
    ...
    */
    ...
    @IBAction func save(_ sender: Any) {
        ...
        guard let tempId = tIndividual.getIdString() as String?,
              let tempProfilePicture = tIndividual.img as String?,
        ...
        tempIndividual.first_name = tempFullName
        tempIndividual.last_name = String("")
        tempIndividual.birthdate = tempBirthDate
        tempIndividual.affiliation = tempAffiliate
        tempIndividual.img = tempProfilePicture
